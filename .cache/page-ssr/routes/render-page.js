...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 883).then(__webpack_require__.bind(__webpack_require__, 429)),"component---src-pages-cennik-js":()=>__webpack_require__.e(/* import() | component---src-pages-cennik-js */ 324).then(__webpack_require__.bind(__webpack_require__, 3661)),"component---src-pages-galeria-js":()=>__webpack_require__.e(/* import() | component---src-pages-galeria-js */ 771).then(__webpack_require__.bind(__webpack_require__, 7083)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 678).then(__webpack_require__.bind(__webpack_require__, 4118)),"component---src-pages-kontakt-js":()=>__webpack_require__.e(/* import() | component---src-pages-kontakt-js */ 628).then(__webpack_require__.bind(__webpack_require__, 7395)),"component---src-pages-pomoc-js":()=>__webpack_require__.e(/* import() | component---src-pages-pomoc-js */ 49).then(__webpack_require__.bind(__webpack_require__, 5013)),"component---src-pages-regulamin-js":()=>__webpack_require__.e(/* import() | component---src-pages-regulamin-js */ 439).then(__webpack_require__.bind(__webpack_require__, 9989)),"component---src-templates-using-dsg-js":()=>__webpack_require__.e(/* import() | component---src-templates-using-dsg-js */ 713).then(__webpack_require__.bind(__webpack_require__, 4808))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-image',plugin:__webpack_require__(2588),options:{"plugins":[]}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(5822),options:{"plugins":[],"name":"gatsby-starter-default","short_name":"starter","start_url":"/","background_color":"#663399","display":"minimal-ui","icon":"src/images/logoBrowser.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"d78732002478dffe2ea3608955dd231d"}},{name:'default-site-plugin',plugin:__webpack_require__(3050),options:{"plugins":[]}},{name:'partytown',plugin:__webpack_require__(5292),options:{"plugins":[]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
const trimmedPathname=stripPrefix(pathname,decodeURIComponent("/gatsbywebsite"))// Remove any hashfragment
...
if(this.staticQueryDb[staticQueryHash]){const jsonPayload=this.staticQueryDb[staticQueryHash];return{staticQueryHash,jsonPayload};}return this.memoizedGet(`${"/gatsbywebsite"}/page-data/sq/d/${staticQueryHash}.json`).then(req=>{const jsonPayload=JSON.parse(req.responseText);return{staticQueryHash,jsonPayload};}).catch(()=>{throw new Error(`We couldn't load "${"/gatsbywebsite"}/page-data/sq/d/${staticQueryHash}.json"`);});})).then(staticQueryResults=>{const staticQueryResultsMap={};staticQueryResults.forEach(({staticQueryHash,jsonPayload})=>{staticQueryResultsMap[staticQueryHash]=jsonPayload;this.staticQueryDb[staticQueryHash]=jsonPayload;});return staticQueryResultsMap;});return Promise.all([componentChunkPromises,staticQueryBatchPromise]).then(([pageResources,staticQueryResults])=>{let payload;if(pageResources){payload={...pageResources,staticQueryResults};finalResult.payload=payload;emitter.emit(`onPostLoadPageResources`,{page:payload,pageResources:payload});}this.pageDb.set(pagePath,finalResult);if(finalResult.error){return{error:finalResult.error,status:finalResult.status};}return payload;})// when static-query fail to load we throw a better error
...
/******/ 			return "" + {"49":"component---src-pages-pomoc-js","324":"component---src-pages-cennik-js","439":"component---src-pages-regulamin-js","628":"component---src-pages-kontakt-js","678":"component---src-pages-index-js","713":"component---src-templates-using-dsg-js","771":"component---src-pages-galeria-js","883":"component---src-pages-404-js"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
await apiRunnerAsync(`replaceRenderer`,{bodyComponent,replaceBodyHTMLString,setHeadComponents,setHtmlAttributes,setBodyAttributes,setPreBodyComponents,setPostBodyComponents,setBodyProps,pathname:pagePath,pathPrefix:"/gatsbywebsite"});// If no one stepped up, we'll handle it.
...
if(!isRedirect(e))throw e;}}apiRunner(`onRenderBody`,{setHeadComponents,setHtmlAttributes,setBodyAttributes,setPreBodyComponents,setPostBodyComponents,setBodyProps,pathname:pagePath,loadPageDataSync,bodyHtml,scripts,styles,pathPrefix:"/gatsbywebsite"});// we want to run Head after onRenderBody, so Html and Body attributes
